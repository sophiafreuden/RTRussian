...
data <- read_delim("klinton-protesty.txt", delim = "*", col_types = col_types)
...
wordcloud(words = head$word, freq = head$count, min.freq = 10,
...
multsum2 %>%
  ...
  tab_header(
    ...
    subtitle = "RT Search Term: 'клинтон оранжевая революция' (clinton orange revolution)"
    )  %>% 
  tab_source_note(
