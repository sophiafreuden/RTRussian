...
sums2 %>%
  group_by(ArtDate) %>% 
  summarise(Frequency = sum(санкций)) %>%
  ggplot(aes(x = ArtDate, y = Frequency)) +
  geom_point() +
  geom_smooth(method = 'loess') +
  labs(
    title = "Term Frequency Per Article Over Time",
    subtitle = "Term: 'санкций' (sanctions)
RT Search Term: 'клинтон протесты' (clinton protests)",
    x = "Date",
    y = "Frequency"
  ...
  ggsave("klinton-protesty/sanction2.png", width = 10)
```
