...
```{r}
choice2 <- sums2 %>% select(c(ArtDate, партии, URL))
...
sums2 %>%
  ...
  labs(
    ...
    subtitle = "Term: 'партии' (party/parties), RT Search Term: N/A, 'Клинтон' (Clinton) Terms",
    x = "Date",
    y = "Frequency"
  ...
  ggsave("all-klinton/party.png", width = 10)
```
